...
class TestVO {
    ...
    public void ex(){
        ...
        System.out.println(myStudent.v1);
        System.out.println(myStudent.v2);
        System.out.println(myStudent.v3);
//        System.out.println(myStudent.v4);
        // v4는 private이기 때문에 같은 패키지여도 안된다.
    }
}
